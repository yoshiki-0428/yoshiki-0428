...
<div style="text-align: right;">2021/08/01 現在</div>
...
| 期間                 | 担当業務                                                                                                                            | 開発環境等                                  | 役割/規模                                         | 
| -------------------- | ----------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------- | ------------------------------------------------- | 
| 2021/06<br>~<br>現在 | **楽天/フリマアプリ追加機能開発**<br>お金周りを中心とした追加機能の開発業務<br><br>**範囲:** 機能検討、設計、コーディング、レビュー | Ruby on Rails 5<br><br>AWS EC2<br>Circle CI | メンバー/200名<br>Business/100名<br>Develop/100名 | 
</div>
